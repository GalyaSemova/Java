...
public class ControllerImpl implements Controller{
    ...
    public String insertDecoration(String aquariumName, String decorationType) {
        Decoration decorationToInsert = decorations.findByType(decorationType);
        ...
        aquarium.getDecorations().add(decorationToInsert);
    ...
    public String addFish(String aquariumName, String fishType, String fishName, String fishSpecies, double price) {
        ...
        if(aquarium.getCapacity() == aquarium.getFish().size() ) {
            output = NOT_ENOUGH_CAPACITY;

        } else if(!fishCanLiveInTheAquarium(aquarium, fishType)) {
    ...
    private boolean fishCanLiveInTheAquarium(Aquarium aquarium, String fishType) {
        String aquariumType = aquarium.getClass().getSimpleName();
        boolean canLive = aquariumType.equals("FreshwaterAquarium") && fishType.equals("FreshwaterFish");
        if(!canLive) {
            canLive = aquariumType.equals("SaltwaterAquarium") && fishType.equals("SaltwaterFish");
        }
        return canLive;
    }
    ...
    public String calculateValue(String aquariumName) {
        ...
        double sumOfFishes = aquarium.getFish().stream().mapToDouble(Fish::getPrice).sum();
        double sumOfDecorations = aquarium.getDecorations().stream().mapToDouble((Decoration::getPrice)).sum();
        double totalSum = sumOfDecorations + sumOfFishes;
